...
export default async function handler(req, res) {
  // CORS: mivel a weboldal (dreamprint-blush.vercel.app) és a backend
  // (dreamprint-backend.vercel.app) két KÜLÖNBÖZŐ domain, a böngésző
  // alapból blokkolná a kérést -- ez a pár sor engedélyezi kifejezetten.
